const events = [
  {
    ...
    'description': 'I did my internship at Jan De Nul in Aalst, and after graduating, I had the ' +
        ...
        'In this role, I primarily work with Angular for the frontend and with C# (.NET) ' +
        'and PLSQL for the backend.',
  },
  {
    'title': 'College: Applied computer science at HoGent',
  ...
  {
    'title': 'High school: Economics modern languages Spanish',
    'fromDate': 'September 2014',
    'toDate': 'June 2020',
    'location': 'Aalst',
    'description': 'I spent six years in high school at DvM Humaniora in Aalst, where I focused on economics ' +
        'and modern languages including Dutch, English, German, French, and Spanish. During this ' +
        'time, I enjoyed making friends and discovering my interests, laying an important ' +
        'foundation for both my personal and academic growth.',
  },
]
