export default function About() {
  ...
  return (
    <div id="about" className="flex flex-col items-center mt-40 max-[1235px]:mt-20">
      {/*<h1 className="m-auto font-bold text-6xl select-none">About</h1>*/}
        <h1 id="about" className="m-auto font-bold text-6xl mb-5 select-none max-[1235px]:text-4xl">About</h1>

        <div className="flex flex-col space-y-5 justify-center items-center w-7/12 max-[1200px]:w-full max-[1200px]:px-10 max-[500px]:px-10 max-[500px]:text-[13px] mt-3 text-center">
